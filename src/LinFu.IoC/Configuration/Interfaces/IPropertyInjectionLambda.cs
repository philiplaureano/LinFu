...
namespace LinFu.IoC.Configuration.Interfaces
{
    ...
    public interface IPropertyInjectionLambda<TService>
    {
        ...
        /// </summary>
        /// <param name="action">
        ///     An <see cref="Action{TService}" /> delegate that will be used to initialize newly created
        ///     services.
        /// </param>
        ...
        /// </summary>
        /// <param name="action">
        ///     An <see cref="Func{IServiceContainer, TService}" /> delegate that will be used to initialize newly
        ///     created services.
        /// </param>
