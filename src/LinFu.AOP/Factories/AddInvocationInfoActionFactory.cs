...
namespace LinFu.AOP.Cecil.Factories
{
    ...
    public class AddInvocationInfoActionFactory : IFactory
    {
        ...
        /// <returns>
        ///     A delegate that can emit the necessary <see cref="IInvocationInfo" /> context that will allow other developers
        ///     to infer information about the method currently being executed.
        /// </returns>
