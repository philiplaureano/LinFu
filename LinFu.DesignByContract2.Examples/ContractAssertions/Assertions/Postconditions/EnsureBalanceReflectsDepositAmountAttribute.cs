...
namespace CSContractAssertions
{
    ...
    public class EnsureBalanceReflectsDepositAmountAttribute : Attribute, IPostcondition
    {
        ...
        {
            output.WriteLine("Deposit Failed! The expected balance should have been '{0}'", _expectedBalance);
        }
